...
# sd.get_point()
# sd.get_vector()
# Возможный результат решения см lesson_004 - Функции подробнее/results/exercise_04_fractal_01.jpg
...
# Возможный результат решения см lesson_004 - Функции подробнее/results/exercise_04_fractal_02.jpg
