...
# Код функций из упр lesson_004 - Функции подробнее/02_global_color.py скопировать сюда
# Результат решения см lesson_004 - Функции подробнее/results/exercise_03_shape_select.jpg
